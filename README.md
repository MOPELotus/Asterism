...
- Chaoxing 能力级上游审计、独立 Chapter / Work / Exam TaskInventory、有界 Work 详情状态复核、Cookie 自动续登与显式开发验证入口；
...
| 第一批 | `chaoxing`、`welearn`、`uai`、`cidaren` | 开发中（Chaoxing 已建立 Password → Cookie → Course / Chapter / Work / Exam 的开发验证链路，尚未完成真实账号验证） |
