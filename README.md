...
- UAI clean-room 上游审计及 fixture-only CourseResource / Unit / Section / Micro / Group 有界解析；Course 点数、Task completion 和 Learning Duration 保持独立，Password → openid/JWT、原生网络与时长上报尚未接入；
