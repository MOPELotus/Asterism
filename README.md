...
- Chaoxing 能力级上游审计、独立 Chapter / Resource / Work / Exam TaskInventory、按稳定身份重新发现的 TaskDetail、Document / Read / Video 原生执行与只读远端进度复核、有界 Work 详情状态复核、Cookie 自动续登与显式开发验证入口；
