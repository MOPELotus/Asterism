...
pub use browser_bridge::{
    ...
    UaiBrowserCursorPersistenceRecovery, UaiBrowserEvent, UaiBrowserEventDocument,
    UaiBrowserEventEnvelope, UaiBrowserEventExchangeCompleted, UaiBrowserEventInbox,
    UaiBrowserExchangeIssued, UaiBrowserHelperAction, UaiBrowserHelperClickKind,
    UaiBrowserHelperClickRecipe, UaiBrowserHelperClickStep, UaiBrowserHelperCommandProjection,
    UaiBrowserHelperDomProfile, UaiBrowserHelperDomRecipe, UaiBrowserHelperMenuFamilyRecipe,
    UaiBrowserHelperMenuHierarchyRule, UaiBrowserHelperMenuLeafRule,
    UaiBrowserHelperMenuObservation, UaiBrowserHelperMenuRecipe, UaiBrowserHelperObservation,
    UaiBrowserHelperPageActiveRule, UaiBrowserHelperPageObservation, UaiBrowserHelperPageRecipe,
    UaiBrowserHelperResidenceObservation, UaiBrowserHelperResidenceRecipe,
    UaiBrowserHelperTextField, UaiBrowserMenuEntry, UaiBrowserMessageSecurity, UaiBrowserPageEntry,
    UaiBrowserPageScope, UaiBrowserResidenceControl, UaiBrowserResidenceExchangeCompleted,
    UaiBrowserResidenceInbox, UaiBrowserResidencePlan, UaiBrowserResidenceResult,
