...
export function AnswerWorkflowPage() {
  ...
  const aiGenerate = useMutation({
    mutationFn: async () => {
      ...
      return requireData(await generateAiAnswerCandidates({ path: { task_id: taskId, snapshot_id: snapshotId }, body: { profile: aiProfile, route: aiRoute, question_ids: questionIds, force_refresh: forceAiRefresh } }));
    },
