...
| `welearn` | [`Fanyuchang2026/welearn-helper`](https://github.com/Fanyuchang2026/welearn-helper) | `afa87fb7c86d` | 2026 SSO/OIDC, Course/Unit/SCO inventory and CMI lifecycle | Reference | No license found; decompiled/derived lineage | 2026-08-09 | Password/OIDC, scoped Cookie, Core-bound stored-session resolution and renewal, bounded Course/Unit/SCO reads and disabled-by-default daemon composition have offline/native-boundary coverage; all live validation pending |
