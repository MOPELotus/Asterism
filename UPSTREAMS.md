...
|---|---|---|---|---|---|---|---|
| `chaoxing` | [`Samueli924/chaoxing`](https://github.com/Samueli924/chaoxing) | `dee643fd0a8e` | Auth, Session, Course, Chapter, Resource, Chapter Work | Reference | GPL-3.0 | 2026-08-09 | Auth, Course, Chapter and bounded chapter-resource inventory have offline/native-boundary coverage; Document/Read execution plus fresh-card verification are offline-covered; Video/Live/Chapter Work execution and all live validation pending |
