...
| `welearn` | [`Fanyuchang2026/welearn-helper`](https://github.com/Fanyuchang2026/welearn-helper) | `afa87fb7c86d` | 2026 SSO/OIDC, Course/Unit/SCO inventory and CMI lifecycle | Reference | No license found; decompiled/derived lineage | 2026-08-09 | Password/OIDC, scoped Cookie, Core-bound stored-session resolution, bounded Course/Unit/SCO reads and disabled-by-default daemon composition have offline/native-boundary coverage; renewal and all live validation pending |
| `welearn` | [`YZBRH/Welearn_helper`](https://github.com/YZBRH/Welearn_helper) | `bd160e91d045` | SSO redirects, Course/Unit/SCO inventory, CMI read/heartbeat/finalize | Reference | No license found; README attributes an earlier GPL-3.0 project without supplying license text | 2026-08-09 | Static donor audit only; all live validation pending |
