...
| `welearn` | [`Fanyuchang2026/welearn-helper`](https://github.com/Fanyuchang2026/welearn-helper) | `afa87fb7c86d` | 2026 SSO/OIDC, Course/Unit/SCO inventory and CMI lifecycle | Reference | No license found; decompiled/derived lineage | 2026-08-09 | Password/OIDC, scoped Cookie, Core-bound stored-session resolution and bounded Course/Unit/SCO reads have offline/native-boundary coverage; renewal, daemon registration and all live validation pending |
