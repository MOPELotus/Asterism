...
| `welearn` | [`Fanyuchang2026/welearn-helper`](https://github.com/Fanyuchang2026/welearn-helper) | `afa87fb7c86d` | 2026 SSO/OIDC, Course/Unit/SCO inventory and CMI lifecycle | Reference | No license found; decompiled/derived lineage | 2026-08-09 | Password encoding/outcome classification and bounded Course/Unit/SCO parsing have synthetic offline coverage; all live validation pending |
