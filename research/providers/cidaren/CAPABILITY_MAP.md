...
5. **Pre-Question child prerequisite (`CIDAREN-CORE-GAP-QUESTION-BLOCKED`).**
   ...
   rejection, and can encode them with both Task identities as the bounded
   `cidaren.question-blocked-step.v1` recovery artifact. The shared Question
