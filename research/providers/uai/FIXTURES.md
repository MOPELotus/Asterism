...
- Runtime schema v2 validates conservative Provider/account concurrency and account scan defaults plus bounded Provider/account/Task overrides for residence seconds, video playback and direct-discussion `marker|placeholder` mode; mutation paths reject incomplete or stale-schema snapshots.
