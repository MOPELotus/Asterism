...
- Browser residence execution fixtures remain required as its shared executor lands; their absence is a tracked implementation gap, not a first-batch deferral. Exit-ticket, exact single-oral-family, single-upload and mixed choice/upload Provider mutation boundaries are covered offline, pending shared registration and live validation; mixed oral compound work remains open.
