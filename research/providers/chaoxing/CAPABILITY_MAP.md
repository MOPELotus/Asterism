...
- The same fresh pending independent Work state now advertises
  ...
  `不正确` or `错误但对` cannot be promoted by substring matching. Multi-blank
  and short-answer Work mutations remain fail-closed. This is synthetic/offline
