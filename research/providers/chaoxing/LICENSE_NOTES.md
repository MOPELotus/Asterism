# chaoxing license notes

Audit date: 2026-08-09

| Source | License | Allowed use in the current unlicensed Asterism tree |
|---|---|---|
...
No donor code was copied into Asterism during this audit. The research notes record
observed behavior and call-chain facts. If implementation later ports GPL source,
the repository license, source notices and distribution obligations must be
resolved before that code is committed. If implementation adapts MIT source, add
the relevant attribution to `NOTICE` in the same logical change.
